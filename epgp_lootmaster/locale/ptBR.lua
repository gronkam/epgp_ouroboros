-- Traduzido por Jizar - Guilda Fenix (Tol-Barad)

local L = LibStub("AceLocale-3.0"):NewLocale("EPGPLootmaster", "ptBR")
if not L then return end

L["Add note"] = "Editar nota"
L["Allow candidates to add notes to each item."] = "Permitir que os candidatos adicione notas a cada item"
L["Allows you to manually set the response for a given candidate"] = "Permite que voce defina manualmente a resposta para um determinado candidato"
L["Always enable bidding"] = "Sempre ativar os lances"
...
L["Always use EPGPLootmaster to distribute loot, without asking"] = "Sempre use EPGPLootmaster para distribuir loot, sem pedir"
L["Amount of buttons to display:"] = "Quantidade de botões para exibir:"
L["Announce loot"] = "Anunciar Saque"
L["Announce loot & request bids"] = "Anunciar os lances de loot e pedido"
L["Ask me every time I become loot master"] = "Pergunte-me cada vez que eu me tornei mestre saqueador"
L["Attempts to send the loot to the candidate and awards %s GP to the candidate"] = "Tenta enviar o saque para o candidato e premiar %s GP para o candidato"
...
L["Auto announcement"] = "Anucio automatico"
...
L["Auto message: please install EPGPLootmaster from curse.com:  http://wow.curse.com/downloads/wow-addons/details/epgp_lootmaster.aspx"] = "Messagem Automatica: Por favor instale o EPGPLootmasterBR de: http://www.wowinterface.com/downloads/info21140-EPGPLootmasterBR.html"
...
L["Auto pass; Enchanter (%s)"] = "Passe Automatico; Encantador (%s)"
L["Autopassing %s (not eligible)"] = "Autopasse %s (nao elegível)"
L["Auto pass (not eligible)"] = "Passe Automatico (nao elegíveis)"
L["bank"] = "Banco"
L["Bid"] = "Licitar"
L["Bidding system"] = "sistema de licitacao"
-- L[", BoE"] = ""
-- L[", BoP"] = ""
-- L[", BoU"] = ""
-- L["Button 1"] = ""
...
-- L["Button caption"] = ""
-- L["Button text:"] = ""
L["Candidate"] = "Candidatos"
L["Candidate did not respond on time."] = "Candidato nao respondeu a tempo"
L["Candidate's current equipment:"] = "Equipamento do Candidato:"
L["- Cannot distribute loot -"] = "- Nao e possível distribuir o saque -"
L[ [=[

|cFFFF8080WARNING: Alot of settings have been hidden because the EPGPLootmaster 'ML' module has been disabled. Please enabled it from the addon configuration screen.|r]=] ] = [=[|cFFFF8080WARNING: Diversas configuracões foram ocultas por que o módulo 'ML' do EPGPLootmaster foi desabilitado. Por favor habilite-o na pagina de configuracao de addons. |r
]=] -- Needs review
...
L["Click and drag to move this window."] = "Clique e arraste para mover esta janela."
...
L["Click to vote for this candidate"] = "Clique para votar neste candidato"
L["Close"] = "Fechar"
...
L["Discard loot"] = "Discarta saque"
L["disenchanted"] = "Desencantado"
-- L["Doubleclick to fold/unfold this window."] = ""
L[ [=[
Empty: use normal GP value 
50%: use 50% of normal GP value 
25: all items are worth 25 GP]=] ] = [=[Vazio: usar valor normal de GP
50%: usar 50% do valor normal de GP
25: todos os itens valem 25 GP]=] -- Needs review
-- L["Enable the bidding system"] = ""
-- L["Enable the voting system"] = ""
L["EPGP is an in game, relational loot distribution system. LootMaster helps you distribute loot to your raid and registers this loot in the EPGP system."] = "EPGP e um sistema dentro do jogo de distribuicao de saque em raides. LootMaster ajuda a distribuir os items e registra esses items no sistema EPGP."
...
L["General config"] = "Configuracao Geral"
L["Give loot and award %s GP"] = "De saque e adicione %s GP"
L["Give loot and award %s GP (100%%)"] = "De saque e adicione %s GP (100%%)"
-- L["Give loot and award %s GP Bid"] = ""
--L["Give loot and award %s GP for %s (%s)"] = ""
L["Give loot for bank"] = "De saque para o Banco"
L["Give loot for disenchantment"] = "De saque para Disencantar"
L["Give loot for free"] = "De saque gratiz"
L["GP value:"] = "Valor de GP"
-- L["GP value override"] = ""
L["Greed"] = "Ganancia" -- <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
L["Greed / Alt"] = "Ganancia para Alt"
L["Guild"] = "Guilda"
...
-- L["Looted"] = "Saqueado"
-- L["looter: %s"] = ""
L[" (Loot not registered in CT_RaidTracker; please set it manually)"] = "(Saque nao registrado no CT_RaidTracker; por favor registre-o manualmente)" 
L[" (Loot registered in CT_RaidTracker)"] = "(Saque registrado no CT_RaidTracker)"
L[" (Loot registered in HeadCount)"] = "(Saque registrado no HeadCount)"
-- L["Loot selection timeout"] = ""
L["Mainspec"] = "Preciso Muito"  -- <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
-- L["Mainspec / Need"] = ""
...
L[" or %s"] = "ou %s" -- Needs review
L["Pass"] = "Nao Preciso"  --  <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
L["Pass; Enchanter (%s)"] = "Passe; Encantador (%s)"
...
L["Raid/Party"] = "Raide/Grupo"
L["Random roll"] = "Rolagem Aleatoria"
L["Rank"] = "Ranke na guilda"
...
L["%s is offline, out of range or not grouped, unable to inspect."] = "%s esta offline, fora de alcance ou nao esta no grupo, incapaz de inspecionar." -- Needs review
L["%s not found on the loot list, perhaps it has already been looted?"] = "%s nao encontrado na lista de loot, talvez ja tenha sido distribuído?" -- Needs review
L["\"%s\" not understood. usage:"] = "\"%s\" nao foi entendido. uso:" -- Needs review
...
L["%s received %s for bank%4$s."] = "%s recebeu %s para o banco%4$s." 
L["%s received %s for disenchantment%4$s."] = "%s recebeu %s para desencanta-lo%4$s."
L["%s received %s for %s GP%s."] = "%s recebeu %s por %s GP%s." 
L["%s received %s for unknown reason%4$s."] = "%s recebeu %s por uma razao desconhecida%4$s." 
L["%s rolled %s."] = "%s rolou %s."
L["%s secs until pass"] = "%s segs para acabar"
...
L[" (Unable to register in CT_RaidTracker; no raid started)"] = "(Incapaz de registrar no CT_RaidTracker; nenhuma raid iniciada)" -- Needs review
L[" (Unable to register in HeadCount; item found, candidate wrong)"] = "(Incapaz de registrar na contagem; item encontrado, candidato errado)" -- Needs review
L[" (Unable to register in HeadCount; itemID not found)"] = "(Incapaz de registrar no HeadCount; ID do item nao encontrado)" -- Needs review
L[" (Unable to register in HeadCount; last item not found)"] = "(Incapaz de registrar no HeadCount; último item nao encontrado)" -- Needs review
L[" (Unable to register in HeadCount; no active raid)"] = "(Incapaz de registrar no HeadCount; nenhuma raid ativa)" -- Needs review
L[" (Unable to register in HeadCount; no lootlist available)"] = "(Incapaz de registrar no HeadCount; nenhuma lista de loot disponível)" -- Needs review
L[" (Unable to register in HeadCount; no raidTracker)"] = "(Incapaz de registrar no HeadCount; nenhum raidTracker)" -- Needs review
...
L["Use EPGPLootmaster"] = "Use EPGPLootmasterBr"
...
L["Version Checker"] = "Checar versao"
L["Vote"] = "Voto"
L["Votes"] = "votos"
L["Voting system"] = "Sistema de votacao"
-- L["When should bidding be available to player?"] = ""
L["Whisper"] = "Sussurrar"
L["Whisper selected"] = "Susurrar Selecionado"
