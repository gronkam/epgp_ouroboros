...
L["Attempts to send the loot to the candidate for disenchantment."] = "Intentos de mandar el bot\195\173n al candidato para desencantarlo." -- Needs review
L["Attempts to send the loot to the candidate for storage in bank."] = "Intentos de mandar el bot\195\173n al candidato para guardarlo en el banco." -- Needs review
...
L["Auto looting of %s to %s failed. Not a candidate for this loot."] = "Despojar autom\195\161ticamente %s to &s ha falldo. No es un candidato para este bot\195\173n." -- Needs review
L["Auto looting %s to %s"] = "Despojar autom\195\161ticamente %s to &s" -- Needs review
...
-- L["Bid"] = ""
-- L["Bidding system"] = ""
L[", BoE"] = ", Ligado al Equiparse(LaE)" -- Needs review
...
L["Button 5"] = "Bot\195\179n5"
L["Button 6"] = "Bot\195\179n 6"
L["Button 7"] = "Bot\195\179n7"
...
L["Candidate did not respond on time."] = "El candidato no respondio a tiempo." -- Needs review
L["Candidate's current equipment:"] = "Equipo actual del candidato:" -- Needs review
...
L["Change this to the GP value you wish to set for this item"] = "Cambiar esto al valor de GP que deseas ponerle a este objeto" -- Needs review
L["Check if you want display incoming monitor updates. This function allows you to see the masterlooter interface so you can help in making decisions about the loot distribution."] = "Comprueba si quieres mostrar las actualizaciones de entrada del monitor. Esta funci\195\179n te permite ver la interfaz del maestro despojador para que puedas ayudar en la toma de decisiones acerca de la distribuci\195\179n del bot\195\173n." -- Needs review
...
-- L["Minor Upgrade"] = ""
-- L["Monitoring"] = ""
L["** MONITORING ** Only %s may distribute this item **"] = "**MONITOREANDO** Solo %s podr\195\161 distribuir este objeto**" -- Needs review
...
-- L["Random roll"] = ""
-- L["Rank"] = ""
L["(Re)announce loot to candidate"] = "(Re)anunciar botin al candidato" -- Needs review
...
L["%s is offline, out of range or not grouped, unable to inspect."] = "%s esta desconectado, fuera de rango o no agrupado, imposible de inspeccionar." -- Needs review
L["%s not found on the loot list, perhaps it has already been looted?"] = "%s no encontrado en la lista de botin, quizas ya haya sido despojado?"
...
L["%splease whisper me !epgp need/greed/pass %s  (or use the popup if you have EPGPLootmaster installed)"] = "%s Por favor susurrame !epgp need/greed/pass %s  (o usa la ventana emergente si tienes EPGPLootmaster instalado)" -- Needs review
L["%s received %s for bank%4$s."] = "%s recibi\195\179 %s para banco%4$s" -- Needs review
L["%s received %s for disenchantment%4$s."] = "%s recibido %s para desencantar%4$s" -- Needs review
...
L["%s sent \"%s %s\"; not understood, returned usage list."] = "%s sent \"%s%s\"; no se entiende, volver a la lista de uso" -- Needs review
...
L[" (Unable to register in HeadCount; itemID not found)"] = "(No es posible registrar en HeadCount; el ID del \195\173tem no fue encontrado)" -- Needs review
